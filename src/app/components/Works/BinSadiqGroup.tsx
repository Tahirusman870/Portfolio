  ...
  return (
    <div>
        ...
        <div className="mx-[1px] min-h-[450px] flex flex-col justify-center align-center">
          <div className="duration-500 h-[450px] hidden group-hover:flex group-active:flex group-focus:flex flex-col justify-between align-center">
            ...
            <p className="text-center mx-5">
              BinSadiq Group is a modern and exceptionally simple real estate
              company website. It includes many material, from layouts to all
              the mandatory features and functions.
            </p>
      ...
      <div className="hidden md:flex w-full mb-28 last-of-type:mb-5 relative flex-row-reverse text-left">
        <div className="mb-[2rem] rounded-lg shadow-[0px_0px_16px_11px] shadow-[rgba(96,138,177,0.43)] flex-[50%] md:mt-8 max-w-[430px] absolute ">
          <Image
            src="/works/BinSadiq-Web.jpeg"
            alt="Bin Sadiq Group"
            width={500}
            height={500}
            className="w-full h-full rounded-lg "
        ...
        <div className="mb-[2rem] flex-[40%] flex flex-col z-[2] items-start">
          <div className="">
