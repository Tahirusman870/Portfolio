        ...
        <div className="mx-[1px] min-h-[450px] flex flex-col justify-center align-center">
          <div className="duration-500 h-[450px] hidden group-hover:flex group-active:flex group-focus:flex flex-col justify-between align-center">
            ...
            <p className="text-center mx-5">
              Complete e-commerce where users can create an account and log in,
              add products to a cart, shop, filter products, name, and brand,
              see the order list, and much more.
            </p>
            <div className="flex justify-center items-center flex-col">
              ...
              <div className="flex my-5">
                <a
                  ...
                  href="https://dynamic.dynamatics.co/"
                  target="_blank"
                  rel="noreferrer"
                >
